...
class uniqueMultiColumnValidator extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		if($exists)
		{
			...
			$message = $this->message!==null ? $this->message : "This athlete has already been registered for this event.";
			foreach ($attributes as $attribute)
			{
				if($attribute == 'first_name') $this->addError($object,$attribute,$message);
			}
		}
	}
}
