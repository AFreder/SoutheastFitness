...
class RegistrationForm extends CForm
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('verifyCode, first_name, last_name, gender, email, verifyEmail', 'required'),
			array('first_name+last_name+email+event_id+gender+actv_in', 'application.extensions.uniqueMultiColumnValidator'),
